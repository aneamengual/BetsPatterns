...
public class VerPronosticosGUI extends JFrame {
	...
	private void verPronostico() throws Exception
	{
		...
		jButtonClose.setBounds(373, 521, 130, 30);
		jLabelPronosticos.setBounds(40, 366, 636, 16);
		...
		this.jCalendar1.addPropertyChangeListener(new PropertyChangeListener()
		{
			public void propertyChange(PropertyChangeEvent propertychangeevent)
			{
				...
				else if ("calendar".equals(propertychangeevent.getPropertyName()))
				{
...
//					jCalendar1.setCalendar(calendarAct);
					...
					try {
						...
						for (domain.Event ev:events){
							...
							//ev object added in order to obtain it with tableModelEvents.getValueAt(i,2)
							row.add(ev); 
		...
		scrollPanePronosticos.setBounds(40, 383, 419, 113);
		...
		jButtonBack.setBounds(149, 521, 135, 30);
