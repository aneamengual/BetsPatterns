...
public class TrabajadoresGUI extends JFrame {
	...
	private final JButton jButtonCrearPregunta = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestion"));
	private final JButton jButtonCrearEvento = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateEvent"));
	private final JButton jButtonCrearPronos = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateForecast"));
	private final JButton jButtonCerrarApuesta = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CloseBet"));
	...
	/**public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TrabajadoresGUI frame = new TrabajadoresGUI();
