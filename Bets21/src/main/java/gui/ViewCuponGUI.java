...
public class ViewCuponGUI extends JFrame {
	...
	private void ViewCupon(Usuario user) {
		...
		jLabelUsuario.setBounds(DIEZ, 91, 101, 13);
		contentPane.add(jLabelUsuario);
		
		lLabelNumCupones.setBounds(DIEZ, 125, 135, 13);
		contentPane.add(lLabelNumCupones);
		

		jLabelSaldo.setBounds(DIEZ, 162, 133, 13);
		...
		//jLabelCupon.setFont(new Font("Times New Roman", Font.PLAIN,40));
		jLabelCupon.setBounds(DIEZ, DIEZ, 399, 57);
		contentPane.add(jLabelCupon);
		jButtonBack.setFont(new Font("Tahoma", Font.PLAIN, DIEZ));
