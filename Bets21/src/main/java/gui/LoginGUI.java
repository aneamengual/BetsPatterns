...
public class LoginGUI extends JFrame {
	...
	private final JLabel jLabelNombreUsuario = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("NombreUsuario"));
	private final JLabel jLabelContraseña = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("Contraseña"));
	private final JButton jButtonIniciarSesion = new JButton(ResourceBundle.getBundle("Etiquetas").getString("IniciarSesion"));
	...
	private void Login_unidad() throws Exception{
		...
		jLabelContraseña.setBounds(35, 93, 96, 19);
