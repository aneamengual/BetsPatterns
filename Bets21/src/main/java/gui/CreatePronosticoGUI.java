...
public class CreatePronosticoGUI extends JFrame {
	...
	private final JLabel lblNewLabel = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("CreatePronosticoGUI.lblNewLabel.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private final JLabel JLabelGanancia= new JLabel(ResourceBundle.getBundle("Etiquetas").getString("CreatePronosticoGUI.JLabelGanancia.text")); //$NON-NLS-1$ //$NON-NLS-2$
...
//					jCalendar1.setCalendar(calendarAct);
		...
		tableEvents.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (queries.isEmpty())
					jLabelQueries.setText(ResourceBundle.getBundle("Etiquetas").getString("NoQueries")+": "+event.getDescription());
				else 
					jLabelQueries.setText(ResourceBundle.getBundle("Etiquetas").getString("SelectedEvent")+" "+event.getDescription());
		...
		//textField_1.setToolTipText(ResourceBundle.getBundle("Etiquetas").getString("CreatePronosticoGUI.textField_1.toolTipText"));
		textField_1.setText("");
