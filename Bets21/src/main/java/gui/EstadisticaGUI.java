...
public class EstadisticaGUI extends JFrame {
	...
	private final JLabel jLabelUserMasApostado = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("UMasApostado"));
	private final JLabel jLabelUMayorApuesta = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("UMayorApuesta"));
	private final JLabel jLabelEMasApostados = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("EMasApostados"));
	private final JLabel jLabelSMasApostadas = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("SMasApostadas"));
	...
	private final JLabel jLabelEstadistica = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("Estadisticas")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void Estadistica() {
		...
		jLabelSolMasApostado.setText(facade.usuarioMasApostado().getNombreUsuario()+", "+facade.usuarioMasApostado().getNombre()+", "+facade.usuarioMasApostado().getDNI());
		//jLabelSolMasApostado.setText(esta.getUsuarioMasApostado().getNombreUsuario()+", "+esta.getUsuarioMasApostado().getNombre()+", "+esta.getUsuarioMasApostado().getApellido1());
		...
		jLabelSolMayorApuesta.setText(facade.usuarioMayorApuesta().getNombreUsuario()+", "+facade.usuarioMayorApuesta().getNombre()+", "+facade.usuarioMayorApuesta().getDNI());
		//jLabelSolMayorApuesta.setText(esta.getUsuarioMayorApuesta().getNombreUsuario()+", "+esta.getUsuarioMayorApuesta().getNombre()+", "+esta.getUsuarioMayorApuesta().getApellido1());
		...
		Vector<Event> eventos= facade.eventosMasApostados();
		//Vector<Event> eventos= esta.getEventosMasapostado();
		for(int i=0; i<eventos.size();i++) {
			eventosMasApostados.addElement(eventos.get(i).getEventNumber()+" "+eventos.get(i).getEventDate()+" "+eventos.get(i).getDescription());
		}
		...
		Vector<Seleccion> sel= facade.seleccionesMasApostadas();
		//Vector<Seleccion> sel= esta.getSeleccionesMasApostadas();
		for(int i=0; i<sel.size();i++) {
			selMasApostadas.addElement(sel.get(i).getDeporte() +", "+ sel.get(i).getGenero() +", "+ sel.get(i).getSeleccion());
		}
		...
		//jLabelSolGanancias.setText(String.valueOf(esta.getGanancias()));
		...
		//ArrayList<Usuario> ln= esta.getListaNegra();
