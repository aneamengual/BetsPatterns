...
public class comprobarDABTest {
	...
	@Test
	// Ni el usuario ni la contraseña estan en la base de datos auqnue los 
	...
	// y la contrseña tambien es correcta
	public void test2() {
		String nombreUsuario="maider";
		String password="zermoduz";
	...
	@Test
	// Es usuario esta en la base de datos pero la contraseña pasada es incorrecta
	public void test3() {
		String nombreUsuario="maider";
